...
using MovieQuoteService.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MovieQuoteService.Application.TodoLists.Commands.CreateTodoList;
using MovieQuoteService.Domain.Entities;
using MovieQuoteService.Domain.Enums;
using FluentAssertions;
using NUnit.Framework;

namespace MovieQuoteService.Application.IntegrationTests.TodoItems.Commands;
